...
<body>
    ...
    <div  class="container">
        ...
        <img id="studentImage"  src="${pageContext.request.contextPath}/img/signup.png" class="semere"  style="height: 100px;">
        <form  action="isignup" method="post" enctype="multipart/form-data">
        <div  class="semere"   style="width: 50%">
         <span  id="message"  style="color:red;font-size: 16px;font-weight: bold;">
           <marquee scrolldelay="100" direction="right">Image Signup Page</marquee>  
         </span>
           <hr/>
