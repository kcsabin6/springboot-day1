...
<body>
	...
	<div  class="container">
		...
		<a href="${pageContext.request.contextPath}/fPassword"><button type="button" class="btn btn-warning">Forgot Password</button></a>
		<a href="${pageContext.request.contextPath}/isignup"><button type="button" class="btn btn-secondary">Image Sign Up</button></a>
		</div>
		</form>
	</div>
